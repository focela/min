...
// Package reflection provides reflection functions for internal usage.
package reflection
...
// OriginValueAndKind retrieves the original reflect value and kind.
func OriginValueAndKind(value interface{}) (out ValueKindOutput) {
...
// OriginTypeAndKind retrieves the original reflect type and kind.
func OriginTypeAndKind(value interface{}) (out TypeKindOutput) {
	if value == nil {
		return
	}
...
func ValueToInterface(v reflect.Value) (value interface{}, ok bool) {
	...
	case reflect.Interface:
		// Recursively resolve interface types
		return ValueToInterface(v.Elem())
	default:
		return nil, false
	}
