...
// Package reflection provides reflection utilities for internal use.
package reflection
...
// OriginValueAndKindOutput holds the input and original reflect values and kinds.
...
// GetOriginValueAndKind retrieves the original reflect value and kind.
func GetOriginValueAndKind(value interface{}) (out OriginValueAndKindOutput) {
...
// OriginTypeAndKindOutput holds the input and original reflect types and kinds.
...
// GetOriginTypeAndKind retrieves the original reflect type and kind.
func GetOriginTypeAndKind(value interface{}) (out OriginTypeAndKindOutput) {
	if value == nil {
		return
	}
