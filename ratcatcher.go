...
// Package ratcatcher provides commonly used type/function defines and coupled calling for creating commonly used objects.
package ratcatcher
...
import (
	...
	"github.com/focela/ratcatcher/utils/rmeta"
)

type (
	Var  = rvar.Var        // Var is a universal variable interface, like generics.
	Ctx  = context.Context // Ctx is alias of frequently-used type context.Context.
	Meta = rmeta.Meta      // Meta is alias of frequently-used type rmeta.Meta.
)
