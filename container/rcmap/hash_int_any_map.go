...
func (m *IntAnyMap) GetVar(key int) *rcvar.Var {
	return rcvar.New(m.Get(key))
}

// GetVarOrSet returns a Var with result from GetVarOrSet.
// The returned Var is un-concurrent safe.
func (m *IntAnyMap) GetVarOrSet(key int, value interface{}) *rcvar.Var {
	return rcvar.New(m.GetOrSet(key, value))
}

// GetVarOrSetFunc returns a Var with result from GetOrSetFunc.
// The returned Var is un-concurrent safe.
func (m *IntAnyMap) GetVarOrSetFunc(key int, f func() interface{}) *rcvar.Var {
	return rcvar.New(m.GetOrSetFunc(key, f))
}

// GetVarOrSetFuncLock returns a Var with result from GetOrSetFuncLock.
// The returned Var is un-concurrent safe.
func (m *IntAnyMap) GetVarOrSetFuncLock(key int, f func() interface{}) *rcvar.Var {
...
func (m *IntAnyMap) UnmarshalValue(value interface{}) (err error) {
	...
	switch value.(type) {
	case string, []byte:
		return json.UnmarshalUseNumber(rcconv.Bytes(value), &m.data)
	default:
		for k, v := range rcconv.Map(value) {
			m.data[rcconv.Int(k)] = v
		}
	}
	return
}
