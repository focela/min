...
func (m *AnyAnyMap) GetVar(key interface{}) *rcvar.Var {
	return rcvar.New(m.Get(key))
}

// GetVarOrSet returns a Var with result from GetOrSet.
// The returned Var is un-concurrent safe.
func (m *AnyAnyMap) GetVarOrSet(key interface{}, value interface{}) *rcvar.Var {
	return rcvar.New(m.GetOrSet(key, value))
}

// GetVarOrSetFunc returns a Var with result from GetOrSetFunc.
// The returned Var is un-concurrent safe.
func (m *AnyAnyMap) GetVarOrSetFunc(key interface{}, f func() interface{}) *rcvar.Var {
	return rcvar.New(m.GetOrSetFunc(key, f))
}

// GetVarOrSetFuncLock returns a Var with result from GetOrSetFuncLock.
// The returned Var is un-concurrent safe.
func (m *AnyAnyMap) GetVarOrSetFuncLock(key interface{}, f func() interface{}) *rcvar.Var {
...
func (m AnyAnyMap) MarshalJSON() ([]byte, error) {
	return json.Marshal(rcconv.Map(m.Map()))
}
