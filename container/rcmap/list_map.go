...
import (
	...
	"github.com/focela/ratcatcher/container/rclist"
	...
	"github.com/focela/ratcatcher/internal/rwmutex"
...
type ListMap struct {
	mu   rwmutex.RWMutex
	data map[interface{}]*rclist.Element
	list *rclist.List
}

type rcListMapNode struct {
	key   interface{}
	value interface{}
}
...
func NewListMap(safe ...bool) *ListMap {
	return &ListMap{
		...
		data: make(map[interface{}]*rclist.Element),
		list: rclist.New(),
	}
}
...
func (m *ListMap) IteratorAsc(f func(key interface{}, value interface{}) bool) {
	...
	defer m.mu.RUnlock()
	if m.list != nil {
		var node *rcListMapNode
		m.list.IteratorAsc(func(e *rclist.Element) bool {
			node = e.Value.(*rcListMapNode)
...
func (m *ListMap) IteratorDesc(f func(key interface{}, value interface{}) bool) {
	...
	if m.list != nil {
		var node *rcListMapNode
		m.list.IteratorDesc(func(e *rclist.Element) bool {
			node = e.Value.(*rcListMapNode)
			return f(node.key, node.value)
		})
	}
...
func (m *ListMap) Clear() {
	m.mu.Lock()
	m.data = make(map[interface{}]*rclist.Element)
	m.list = rclist.New()
	m.mu.Unlock()
}
...
func (m *ListMap) Replace(data map[interface{}]interface{}) {
	...
	for key, value := range data {
		if e, ok := m.data[key]; !ok {
			m.data[key] = m.list.PushBack(&rcListMapNode{key, value})
		} else {
			e.Value = &rcListMapNode{key, value}
		}
	}
	m.mu.Unlock()
}
...
func (m *ListMap) MapStrAny() map[string]interface{} {
	...
	if m.list != nil {
		...
		m.list.IteratorAsc(func(e *rclist.Element) bool {
			node = e.Value.(*rcListMapNode)
			data[rcconv.String(node.key)] = node.value
			return true
		})
	}
	m.mu.RUnlock()
...
func (m *ListMap) Search(key interface{}) (value interface{}, found bool) {
	...
	if m.data != nil {
		if e, ok := m.data[key]; ok {
			value = e.Value.(*rcListMapNode).value
			found = ok
		}
	}
	m.mu.RUnlock()
...
func (m *ListMap) doSetWithLockCheck(key interface{}, value interface{}) interface{} {
	...
	if e, ok := m.data[key]; ok {
		return e.Value.(*rcListMapNode).value
	}
...
func (m *ListMap) GetVar(key interface{}) *rcvar.Var {
	return rcvar.New(m.Get(key))
}

// GetVarOrSet returns a Var with result from GetVarOrSet.
// The returned Var is un-concurrent safe.
func (m *ListMap) GetVarOrSet(key interface{}, value interface{}) *rcvar.Var {
	return rcvar.New(m.GetOrSet(key, value))
}

// GetVarOrSetFunc returns a Var with result from GetOrSetFunc.
// The returned Var is un-concurrent safe.
func (m *ListMap) GetVarOrSetFunc(key interface{}, f func() interface{}) *rcvar.Var {
	return rcvar.New(m.GetOrSetFunc(key, f))
}

// GetVarOrSetFuncLock returns a Var with result from GetOrSetFuncLock.
// The returned Var is un-concurrent safe.
func (m *ListMap) GetVarOrSetFuncLock(key interface{}, f func() interface{}) *rcvar.Var {
	return rcvar.New(m.GetOrSetFuncLock(key, f))
}
...
func (m *ListMap) Keys() []interface{} {
	...
	if m.list != nil {
		m.list.IteratorAsc(func(e *rclist.Element) bool {
			keys[index] = e.Value.(*rcListMapNode).key
			index++
			return true
		})
	}
...
func (m *ListMap) Values() []interface{} {
	...
	if m.list != nil {
		m.list.IteratorAsc(func(e *rclist.Element) bool {
			values[index] = e.Value.(*rcListMapNode).value
			index++
			return true
		})
	}
...
func (m *ListMap) Merge(other *ListMap) {
	...
	var node *rcListMapNode
	other.list.IteratorAsc(func(e *rclist.Element) bool {
		node = e.Value.(*rcListMapNode)
		if e, ok := m.data[node.key]; !ok {
			m.data[node.key] = m.list.PushBack(&rcListMapNode{node.key, node.value})
		} else {
			e.Value = &rcListMapNode{node.key, node.value}
		}
		return true
	})
}
...
func (m *ListMap) UnmarshalValue(value interface{}) (err error) {
	...
	for k, v := range rcconv.Map(value) {
		if e, ok := m.data[k]; !ok {
			m.data[k] = m.list.PushBack(&rcListMapNode{k, v})
		} else {
			e.Value = &rcListMapNode{k, v}
		}
	}
	return
}
