...
// NewSortedArrayFrom creates and returns a sorted array with given slice `array`.
// The parameter `safe` is used to specify whether using array in concurrent-safety,
// which is false in default.
...
// NewSortedArrayFromCopy creates and returns a sorted array from a copy of given slice `array`.
// The parameter `safe` is used to specify whether using array in concurrent-safety,
// which is false in default.
...
func (a *SortedArray) Merge(array interface{}) *SortedArray {
	return a.Add(rcconv.Interfaces(array)...)
}
...
func (a *SortedArray) UnmarshalJSON(b []byte) error {
	if a.comparator == nil {
		a.array = make([]interface{}, 0)
		a.comparator = rcutil.ComparatorString
	}
	a.mu.Lock()
	defer a.mu.Unlock()
...
func (a *SortedArray) UnmarshalValue(value interface{}) (err error) {
	...
	switch value.(type) {
	case string, []byte:
		err = json.UnmarshalUseNumber(rcconv.Bytes(value), &a.array)
	default:
