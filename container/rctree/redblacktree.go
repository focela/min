...
// GetVar returns a rcvar.Var with the value by given `key`.
// The returned rcvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVar(key interface{}) *rcvar.Var {
	return rcvar.New(tree.Get(key))
}

// GetVarOrSet returns a rcvar.Var with result from GetVarOrSet.
// The returned rcvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSet(key interface{}, value interface{}) *rcvar.Var {
	return rcvar.New(tree.GetOrSet(key, value))
}

// GetVarOrSetFunc returns a rcvar.Var with result from GetOrSetFunc.
// The returned rcvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSetFunc(key interface{}, f func() interface{}) *rcvar.Var {
	return rcvar.New(tree.GetOrSetFunc(key, f))
}

// GetVarOrSetFuncLock returns a rcvar.Var with result from GetOrSetFuncLock.
// The returned rcvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSetFuncLock(key interface{}, f func() interface{}) *rcvar.Var {
	return rcvar.New(tree.GetOrSetFuncLock(key, f))
}
...
func (tree *RedBlackTree) UnmarshalJSON(b []byte) error {
	...
	if tree.comparator == nil {
		tree.comparator = rcutil.ComparatorString
	}
