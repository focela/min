...
// Package rctag providing tag content storing for struct.
//
...
const (
	...
	RCConv            = "rcconv"       // RCConv defines the converting target name for specified struct field.
	RCConvShort       = "rc"           // RCConv defines the converting target name for specified struct field.
