...
// Package rconv implements powerful and convenient converting functionality for any types of variables.
//
...
import (
	...
	"github.com/focela/ratcatcher/encoding/rbinary"
	"github.com/focela/ratcatcher/internal/intlog"
	"github.com/focela/ratcatcher/internal/json"
	"github.com/focela/ratcatcher/internal/reflection"
...
var (
	...
	// Note that, the `rconv/param` tags are used by old version of package.
	// It is strongly recommended using short tag `c/p` instead in the future.
	StructTagPriority = []string{
		rtag.RConv, rtag.Param, rtag.RConvShort, rtag.ParamShort, rtag.Json,
	}
)
