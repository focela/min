...
// Package rcconv implements powerful and convenient converting functionality for any types of variables.
//
...
var (
	...
	// Note that, the `rcconv/param` tags are used by old version of package.
	// It is strongly recommended using short tag `c/p` instead in the future.
	StructTagPriority = []string{
		rctag.RCConv, rctag.Param, rctag.RCConvShort, rctag.ParamShort, rctag.Json,
	}
)
