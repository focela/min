...
import "github.com/focela/ratcatcher/os/rctime"
...
// iRCTime is the interface for rctime.Time converting.
type iRCTime interface {
	RCTime(format ...string) *rctime.Time
}
