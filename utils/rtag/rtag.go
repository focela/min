...
// Package rtag providing tag content storing for struct.
//
...
const (
	...
	RConv             = "rconv"        // RConv defines the converting target name for specified struct field.
	RConvShort        = "r"            // RConv defines the converting target name for specified struct field.
