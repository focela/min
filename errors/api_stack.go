...
const (
	...
	maxStackDepth = 64
	defaultSkip   = 3 // Default skip level for runtime.Callers
)
...
// HasStack checks and reports whether `err` implemented interface `StackTracer`.
