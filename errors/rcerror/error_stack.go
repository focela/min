...
import (
	...
	"github.com/focela/ratcatcher/internal/consts"
	"github.com/focela/ratcatcher/internal/errors"
)
...
func loopLinesOfStackInfo(st stack, info *stackInfo, isStackModeBrief bool) {
	...
	for _, p := range st {
		if fn := runtime.FuncForPC(p - 1); fn != nil {
			...
			if isStackModeBrief {
				// filter whole Ratcatcher packages stack paths.
				if strings.Contains(file, consts.StackFilterKeyForRatcatcher) {
					continue
				}
			} else {
