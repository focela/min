...
// Package code provides universal error code definitions and implementations for common error codes.
package code
...
var (
	...
	CodeOK                        = localCode{0, "Operation completed successfully", nil} // It is OK.
	...
	CodeOperationFailed           = localCode{60, "Operation Failed", nil}                // The operation could not be completed successfully.
